...
from cabinet import FileItem, StorageHandlerBase
...
class NewStorageHandler(StorageHandlerBase):
    ...
    def _validate(self) -> Optional[Awaitable]:
        ...
        #     raise cabinetConfigError('describe the problem')
        # Can be an async method if necessary and will be awaited on properly.
        raise cabinetConfigError("This is a template, not a real handler!")
